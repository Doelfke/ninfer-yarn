...
| `--kv-dtype bf16\|int8\|fp8\|nvfp4\|nvfp4v2\|k8v4` | KV-cache storage; `nvfp4v2` is a byte-compatible, opt-in, GQA-fused prompt-route variant of `nvfp4` (runtime-only, no artifact change) | `bf16` |
